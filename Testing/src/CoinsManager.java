...
public class CoinsManager {
	...
	private void train10_2(Hashtable<Vector, Integer> learnedMeans) {
		Vector vector_0 = new Vector(8);
		setVectorValues(vector_0, 35.59670027497709,10.636113657195233,44.942254812098994,45.112740604949586,45.37121906507791,54.71127406049496,254.35655362053163,251.77543538038498);
		learnedMeans.put(vector_0, 1084);

		Vector vector_1 = new Vector(8);
		setVectorValues(vector_1, 46.66259711431743,10.259711431742508,58.59822419533851,62.90122086570477,63.88790233074362,62.59156492785794,69.8568257491676,190.93451720310765);
		learnedMeans.put(vector_1, 958);

		Vector vector_2 = new Vector(8);
		setVectorValues(vector_2, 14.634848484848485,1.9530303030303031,18.783838383838383,21.578282828282827,23.29090909090909,17.56111111111111,22.136868686868688,49.69090909090909);
		learnedMeans.put(vector_2, 1997);

		Vector vector_3 = new Vector(8);
		setVectorValues(vector_3, 12.678972712680578,4.386837881219904,14.635634028892456,15.617977528089888,16.46548956661316,18.125200642054576,255.0,32.91653290529695);
		learnedMeans.put(vector_3, 623);

		Vector vector_4 = new Vector(8);
		setVectorValues(vector_4, 114.92102807702095,135.72058698787004,121.09178047332259,119.44058020188311,116.22266519636949,138.87454406650266,193.0892357282212,194.81889897361947);
		learnedMeans.put(vector_4, 11722);
	}
	
	private void train10_3(Hashtable<Vector, Integer> learnedMeans) {
		Vector vector_0 = new Vector(8);
		setVectorValues(vector_0, 19.83855650522317,4.002849002849003,25.02469135802469,28.21130104463438,30.128679962013294,23.767806267806268,29.266381766381766,76.27113010446344);
		learnedMeans.put(vector_0, 2106);

		Vector vector_1 = new Vector(8);
		setVectorValues(vector_1, 49.14603409933284,12.830985915492958,59.73387694588584,59.977761304670125,60.441808747220165,71.44996293550778,234.64343958487768,251.62194217939214);
		learnedMeans.put(vector_1, 1351);

		Vector vector_2 = new Vector(8);
		setVectorValues(vector_2, 122.55259354424281,180.75814999197044,132.47759755901717,128.71719929339972,122.27139874739039,157.83973020716235,235.80070660028906,248.22836036614743);
		learnedMeans.put(vector_2, 6216);

		Vector vector_3 = new Vector(8);
		setVectorValues(vector_3, 16.81359649122807,6.594298245614035,18.87061403508772,19.899122807017545,20.971491228070175,22.62938596491228,255.0,43.06578947368421);
		learnedMeans.put(vector_3, 456);

		Vector vector_4 = new Vector(8);
		setVectorValues(vector_4, 120.78690361831572,94.37800192122958,124.07716938840858,124.50784502081332,124.69900736471341,135.51216778738393,154.2449567723343,147.35222542427152);
